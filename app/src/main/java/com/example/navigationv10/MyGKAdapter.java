...
public class MyGKAdapter extends RecyclerView.Adapter<MyGKAdapter.MyViewHolder> {
    ...
    private ArrayList gk_name_id,gk_adress_id,name_zas_id;


    public MyGKAdapter(Context context, ArrayList gk_name_id, ArrayList gk_adress_id,ArrayList name_zas_id, RecyclerInterface recyclerInterface) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView gk_name_id, gk_adress_id,name_zas_id;
